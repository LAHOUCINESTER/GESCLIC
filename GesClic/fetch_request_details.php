...
if (isset($_GET['id'])) {
    ...
    $content .= '<div class="row">
                    ...
                    <div class="col form-group">
                        <input type="text" class="form-control" value="' . $request['DateSoumission'] . '" readonly>
                    </div>
                </div>';
    $content .= '<div class="row">
                    <div class="col form-group">
    ...
    if ($request['type_dmd'] === 'Congé') {
		...
		$content .= '<div class="row">
                        ...
                        <div class="col form-group">
                            <input type="text" class="form-control" value="' . $congeDetails['periode'] . '" readonly>
                        </div>
                    </div>';
					
        // ... Ajoutez d'autres champs de formulaire spécifiques au congé ...
		...
		<div class="col form-group">
			<input type="text" class="form-control" value="' . $BltnDetails['mois'] . '" readonly>
		</div>
	</div>';
