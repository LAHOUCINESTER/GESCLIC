...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($conn->connect_error) {
        ...
        if ($action === "clock_in" && $result_check_entry->num_rows === 0) {
            $sql = "INSERT INTO pointer (employe_id, date, h_entree_sys, h_entree, statut) VALUES ('$employeId', '$date','$heure_actuelle', '$heure_entree', 'Présent')";
