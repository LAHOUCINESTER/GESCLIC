            ...
            <div class="col-lg-8">
              <div class="card-body p-md-4 mx-md-4">
                <div class="text-center">
                    <div class="navbar-logo"  href="landing.php"><img  src="../images/logo2.png" alt="GesClic"></a></div>
                  ...
                  <form method="POST"  action="<?php echo $_SERVER['PHP_SELF']; ?>"  class="form1" >
                    ...
                    <div class="mb-3">
                                 <div class="form-group">
                                    <label for="formGroupExampleInput" class="form-label">Veuillez choisir votre role :</label>
                                    <span id="TypeError" class=" error-message"><?php echo $errors['user_type']; ?></span>

                                    <div class="input-container">
                                        <select  class="form-select" style="background-color: #edf3ff;" id="user_type" name="user_type"   value="<?php if(isset($_POST["user_type"])) echo  $_POST["user_type"];?>"  required >
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-container">
                                <i class="bi bi-lock icon"></i>
                                <input type="password" class="form-control " name="password2" id="password2" placeholder="Mot de passe" value="<?php if(isset($_POST["password2"])) echo  $_POST["password2"];?>"  aria-describedby="passwordError"required>
                        ...
                        <div class="justify-content-md-end  d-md-flex pt-1  pb-1 mb-4">
                        ...
                        <div class="text-center mt-3">
                            ...
                            <a  class="create-account-link" href="login.php">Se connecter !</span>
                        </div>
                 </form>
              </div>
            </div>
